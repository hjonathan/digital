            ...
            <div class="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/5">
                <dl class="mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:px-2 xl:px-0">
                    <div
                        ...
                        :key="stat.name"
                        :class="[statIdx % 2 === 1 ? 'sm:border-l' : statIdx === 2 ? 'lg:border-l' : '']"
                        class="'flex items-baseline flex-wrap justify-between gap-y-2 gap-x-4 border-t
                        border-gray-900/5 px-4 py-10 sm:px-6 lg:border-t-0 xl:px-8'">
                        <dt class="text-sm font-medium leading-6 text-gray-500">
                            {{ stat.name }}
                        </dt>

                        <dd
                            :class="[stat.changeType === 'negative' ? 'text-rose-600' : 'text-gray-700',
                            'text-xs font-medium']">
                            {{ stat.change }}
                        </dd>
        ...
        <div class="space-y-16 py-16 xl:space-y-20">
            ...
            <div>
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <h2
                        class="mx-auto text-base font-semibold leading-6 text-gray-900 lg:mx-0 lg:max-w-none">
                        Recent activity
                    </h2>
                </div>
                                    ...
                                    <template v-for="day in days" :key="day.dateTime">
                                        <tr class="text-sm leading-6 text-gray-900">
                                            <th scope="colgroup" colspan="3" class="relative isolate py-2 font-semibold">
                                                ...
                                                <div
                                                    class="absolute inset-y-0 right-full -z-10 w-screen border-b
                                                     border-gray-200 bg-gray-50" />

                                                <div
                                                    class="absolute inset-y-0 left-0 -z-10 w-screen border-b
                                                    border-gray-200 bg-gray-50" />
                                            </th>
                                        </tr>
                                        ...
                                        <tr
                                            ...
                                            <td class="py-5 text-right">
                                                <div class="flex justify-end">
                                                    <a class="text-sm font-medium leading-6 text-primary-600 hover:text-primary-500">
                                                        View
            ...
            <div class="mx-auto px-4 sm:px-6 lg:px-8">
                <div class="mx-auto lg:mx-0 lg:max-w-none">
                    <div class="flex items-center justify-between">
                        ...
                        <a class="text-sm font-semibold leading-6 text-indigo-600 hover:text-indigo-500">
                            View all
                            ...
                            <div class="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-6">
                                ...
                                <Menu as="div" class="relative ml-auto">
                                    ...
                                    <transition
                                        ...
                                        <MenuItems
                                            class="absolute right-0 z-10 mt-0.5 w-32 origin-top-right rounded-md
