...
const steps = ref([
    {
        id: 'items_result',
        name: t('Mother'),
        subtitle: t('Mother plant information'),
        status: 'current',
        prefix: 'Mother',
        complete: true,
        optional: false,
        ...
        locationSlug: 'mom-room',
        messageInfo: t('Introduce mother'),
...
const save = async () => {
    ...
    const url = router.currentRoute.value.query.child ? '/stock/take_moms_child' : '/stock/take_moms'
...
<template>
    ...
    <section class="!pt-0">
        <Stepper
            ...
            :disableDirectNavitagion="!navigationIsEnable">
