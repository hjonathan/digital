<script setup>
import { inject, ref, markRaw, onMounted } from 'vue'
...
const save = async () => {
    ...
    const url = router.currentRoute.value.query.child ? '/stock/clone_child' : '/stock/clone'
...
const rightButtons = configRightButtons({ actions: { save }, dataToValidate, rule: 'saveClone' })
...
onMounted(async () => {
    ...
    if (response.success) selectedRows.value = response.data
            ...
            <template
                ...
                <div class="grid grid-cols-12 h-full w-full bg-gray-50 gap-5">
                    ...
                    <div class="col-span-9 pl-4 pr-0 space-y-5">
                        ...
                        <!-- General messages -->
                        <Alert
                            v-model="generalMessage.isOpen"
                            :type="generalMessage.type"
                            :hasCloseButton="false"
                            :content="generalMessage.message" />
