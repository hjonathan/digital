...
const save = async () => {
    ...
    const url = router.currentRoute.value.query.child ? '/stock/change_to_vegetation_child' : '/stock/change_to_vegetation'
    ...
    if (response.success && !response.errors) {
        ...
        tabsStore.closeTab('BeginVegetation')
    }
